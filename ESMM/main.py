...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', help='The directory of model', type=str, default='ESMM.ckpt')
    ...
    X_train_cate.shape, X_train_cont.shape, y_train.shape, X_test_cate.shape, X_test_cont.shape, y_test.shape, cate_list
    ...
    with tf.Session() as sess:
        # define model
        model = ESMM.ESMM(args, cate_num, cont_num, cate_list)
        model.build()
