...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', help='The directory of model', type=str, default='DeepFM.ckpt')
    ...
    parser.add_argument('--dropout_fm', help='dropout rate', type=float, default=0.5)
    ...
    with tf.Session() as sess:
        # define model
        model = DeepFM.DeepFM(args, cate_num, cont_num, cate_list)
        model.build()
